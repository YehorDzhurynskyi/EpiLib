...
#include "EpiDrawer/Text/drwTextFace.cxx"
...
drwTextFace::~drwTextFace()
{
    FT_Done_Face(m_Face);
}

void drwTextFace::PrepareFontMetrics(epiU32 fontSize) const
{
...
drwTextRenderedGlyph drwTextFace::CreateRenderedGlyph(const epiWChar ch, epiU32 fontSize) const
{
    drwTextRenderedGlyph target;
...
drwTextRenderedABC drwTextFace::CreateRenderedABC(const epiWChar* abc, epiU32 fontSize) const
{
    drwTextRenderedABC target;
    ...
    for (epiU32 i = 0; i < abclen; ++i)
    {
        ...
        drwTextRenderedGlyph& glyph = it->second;
...
#if 1
drwTextRenderedAtlas drwTextFace::CreateRenderedAtlas(const epiWChar* atlasText, epiU32 fontSize) const
{
    drwTextRenderedAtlas target;
    ...
    for (epiU32 i = 0; i < atlasTextLen; ++i)
    {
        ...
        drwTextRenderedAtlasGlyph atlasGlyph;
...
#else
gfxTextRenderedAtlas drwTextFace::CreateRenderedAtlas(const epiWChar* atlasText, epiU32 fontSize) const
{
